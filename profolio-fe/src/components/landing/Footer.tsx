    ...
    <footer className="relative z-10 pt-24 pb-12 px-6 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-20 border-b border-border pb-10">
          ...
          <button
            onClick={onStart}
            className="h-14 px-8 text-white font-mono text-xs uppercase tracking-widest hover:opacity-90 transition-all flex items-center gap-2 cursor-pointer shadow-lg rounded-xl"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="size-6 flex items-center justify-center text-white rounded font-serif italic text-sm" style={{ background: 'var(--accent-blue)' }}>
                P
              </div>
