    ...
    <section className="py-24 px-6 relative overflow-hidden" id="showcase">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            <span className="text-xs font-mono uppercase tracking-widest mb-2 block" style={{ color: 'var(--accent-blue)' }}>Metrics</span>
          ...
          <div className="border p-6 w-full md:w-auto min-w-[300px] transition-colors duration-300 rounded-xl" style={{ background: 'rgba(59,111,235,0.04)', borderColor: 'rgba(59,111,235,0.2)', borderLeftWidth: '4px', borderLeftColor: 'var(--accent-blue)' }}>
        ...
        <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden bg-transparent gap-4">
          ...
          <Marquee pauseOnHover className="[--duration:40s] [--gap:2rem] py-2">
            ...
            {/* Card 1: Testimonial */}
            <div className="w-[340px] h-[150px] bg-background p-5 border border-border rounded-xl transition-all duration-300 flex flex-col justify-between hover:-translate-y-2 hover:shadow-xl cursor-pointer group" style={{}} onMouseEnter={e => (e.currentTarget.style.borderColor = 'rgba(59,111,235,0.3)')} onMouseLeave={e => (e.currentTarget.style.borderColor = '')}>
